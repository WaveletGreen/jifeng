...
// NewItemCommand(AIFDesktop.getActiveDesktop(),app,"JF3_GCGGTZD","JF3_GGtongzhi",false);
...
// AIFDesktop.getActiveDesktop(), app, "JF3_GCGGTZD",
// "JF3_GGtongzhi", false);
// commond.executeModal();
// TCComponent comp = (TCComponent) app.getTargetComponent();
// // MessageBox.post("WWWWW","INFO",MessageBox.INFORMATION);
// } catch (Exception e) {
// e.printStackTrace();
// }
// return null;
// }
//public class JFomCreateBGTZDHandler extends AbstractHandler implements
...
public class JFomCreateBGTZDHandler extends AbstractHandler implements
	...
	private class CreateNewBOSWTDialog implements Runnable {
		...
		final JFomCreateBGTZDHandler this$0;

		private CreateNewBOSWTDialog(Shell shell, boolean flag, String s) {
			super();
			this$0 = JFomCreateBGTZDHandler.this;
	...
	public String obType = "JF3_GCGGTZD";
	public String pasteRelation = "JF3_GGtongzhi";
}
