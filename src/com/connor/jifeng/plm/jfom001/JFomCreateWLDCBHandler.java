...
//public class JFomCreateWLDCBHandler extends AbstractHandler {

public class JFomCreateWLDCBHandler extends AbstractHandler implements
	...
	private class CreateNewBOSWTDialog implements Runnable {
		...
		final JFomCreateWLDCBHandler this$0;

		private CreateNewBOSWTDialog(Shell shell, boolean flag, String s) {
			super();
			this$0 = JFomCreateWLDCBHandler.this;
	...
	public String obType = "JF3_WLDCB";
	public String pasteRelation = "JF3_WLdiaocha";
}
...
// // JFomPartCreateCommond commond = new
// JFomPartCreateCommond(AIFDesktop.getActiveDesktop(), app, "Part",
// "IMAN_reference", false);
// // commond.executeModal();
// AbstractAIFUIApplication app = AIFUtility.getCurrentApplication();
// NewItemCommand commond = new
// NewItemCommand(AIFDesktop.getActiveDesktop(),app,"JF3_WLDCB","JF3_WLdiaocha",false);
// commond.executeModal();
//
// } catch (Exception e) {
// e.printStackTrace();
